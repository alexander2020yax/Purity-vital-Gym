<div class="login-container" >
		...
		<div class="login-content" >
			...
			<a href="#" class="logo">
				<img src="../img/logo2020.png" alt="45%" width="60%" />
			</a>
			
			<p class="description" style="font-family:monospace; font-size:25px; color: white;">Bienvenido inicia sesion para acceder Purity Vital Gym</p>

...
<head>
    ...
    <title>Facturacionweb.site | Login </title>
					...
					<form action="change_s_pwd.php" method="POST" id="bb">	
						...
						<div class="form-group">					
							<div class="input-group">
								<div class="input-group-addon">
									...
									<input type="text" class="form-control" name="login_id" placeholder="Tu usuario" data-rule-required="true" data-rule-minlength="6"/>
							</div>
						</div>				
						...
						<div class="form-group">					
							<div class="input-group">
								...
								<input type="text" name="login_key"  class="form-control" placeholder="Escribe tu clave secreta" data-rule-required="true" data-rule-minlength="6">
							</div>				
						</div>
